...
<?php
  if($_POST) {
      ...
      if (isValid()) {
        ...
        setcookie("nombre", old('nombre'), time() + 60 * 60 * 12 * 30);
        setcookie("apellido", old('apellido'), time() + 60 * 60 * 12 * 30);
        setcookie("email", old('email'), time() + 60 * 60 * 12 * 30);
        setcookie("password", old('password'), time() + 60 * 60 * 12 * 30);
